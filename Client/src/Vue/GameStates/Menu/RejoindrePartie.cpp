...
#include "../../../Controleur/GameStates/Menu/RejoindrePartie.h"

namespace Vue
{

	RejoindrePartie::RejoindrePartie(std::vector<Controleur::Choix> choix, Controleur::RejoindrePartie* controleur) : MenuChoix(choix, controleur)
	{
	...
	void RejoindrePartie::setIP(std::string str) {
		ip_.setString(str);
	}
