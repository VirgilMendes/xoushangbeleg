...
namespace Vue
{
		...
		void Unite::initAnimation()
		{
			...
			{
				sf::IntRect(0, 4*RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB),
				sf::IntRect(RES_TEXTURE_XSB, 4*RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB)
			};
			...
			const std::vector < sf::IntRect > deplacementDos =
			{
				...
				sf::IntRect(RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB) ,
				sf::IntRect(2*RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB) ,
				sf::IntRect(3*RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB) ,
				sf::IntRect(4*RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB) ,
				sf::IntRect(5*RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB) ,
				sf::IntRect(6*RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB) ,
				sf::IntRect(7*RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB, RES_TEXTURE_XSB)
			};
